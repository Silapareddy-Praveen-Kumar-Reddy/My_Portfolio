...
export const codingProfiles = [
  ...
  },
  {
    ...
    stats: [
      { label: "Pull Requests", value: "7" },
      { label: "Issues", value: "5" },
      { label: "Repos Contributed", value: "7" },
      { label: "Grade", value: "C+" }
    ],
    rating: 4,
    grade: "C+"
...
export const projects = [
  {
    ...
    description: "Developed an intelligent, Flask-based web system for real-time image recognition of municipal solid waste. Integrated a deep learning model to automate waste categorization, improving potential recycling efficiency by 25%.",
    link: "https://github.com/Silapareddy-Praveen-Kumar-Reddy/Waste-classification-using-Trasfer-Learning"
  },
  {
    title: "AGRIBRIDGE",
    tech: "Flutter, Dart, Firebase, Fast API",
    description: "Designed and developed an app facilitating seamless connectivity for Farmers and Consumers using Flutter and Dart. Implemented location-based search, increasing user matches by 45%.",
    link: "https://github.com/Silapareddy-Praveen-Kumar-Reddy/farmersapp"
  },
  {
    title: "TRASH TO TREASURE",
    tech: "NodeJS, ExpressJS, Firebase, FastAPI",
    description: "Developed a MERN stack application to help with trash maintenance and waste segregation. Implemented a gamification system, increasing user engagement by 25%.",
